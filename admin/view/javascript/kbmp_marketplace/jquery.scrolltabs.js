...
(function($) {
  $.fn.scrollTabs = function(opts){
    var initialize = function(state){
      ...
      var _this = this;
      var mleft = localStorage.getItem("mleft");
	  var scrollPosition = parseInt(mleft - 170);
      ...
      $('.scroll_tab_inner', _this).animate({scrollLeft: mleft + 'px'}, 0);
  ...
  $.fn.scrollTabs.defaultOptions = {
    ...
    click_callback: function(e){
		var mleft = $('.tab_selected').position().left;
		localStorage.setItem("mleft", mleft);
