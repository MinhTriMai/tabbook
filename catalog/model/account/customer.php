...
class ModelAccountCustomer extends Model {
	...
	public function addAddressToCustomer($addresses,  $customer_id) {
		$idx = 1;
		foreach ($addresses as $address) {
				//echo "Adding address  " . $idx . " for customer ID: " . $customer_id . "....<br/>";
