			...
			switch (substr($item, 0, strlen($value[1])))
			{
				...
				case 'LINK': 
                    ...
                    if($link) {
                        ...
                        $this->_menuLink .= '<div id  class ="pt_ver_menu_link pt_ver_menu '. $over_class .'"><div class="parentMenu" ><a href="'.($link['link']).'"><span>'.$link['title'].'</span></a></div></div>'.PHP_EOL;
                    }
				case 'CMS': 
                    ...
                    if(isset($cms['information_id'])) {
                        ...
                        $this->_menuLink .= '<div  class ="pt_ver_menu_cms pt_ver_menu '. $over_class .'"><div class="parentMenu" ><a href="'.$cms_link.'"><span>'.$cms['title'].'</span></a></div></div>'.PHP_EOL;
                    }
			}
            $count++;        
		}
